...
class Scoring:
    ...
    def set_directories(self):
        ...
        self.reference_dir = os.path.join("/data", "atlas","chakkappai","FairUniverse","Full_dataset_01_03_2024","reference_data")
        # self.reference_dir = os.path.join("C:/", "Users","remyl", "HEP-Challenge", "reference_data")
